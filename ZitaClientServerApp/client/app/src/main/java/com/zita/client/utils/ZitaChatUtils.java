package com.zita.client.utils;

import javax.crypto.Cipher;
import javax.crypto.spec.SecretKeySpec;

public class ZitaChatUtils {
    ...
    public static String encodeBase64(byte[] data) {
        return com.zita.client.utils.Base64.encode(data);
    }
    ...
    public synchronized static String decrypt(String encryptedMessage, SecretKeySpec aesKey) throws Exception {
        ...
        byte[] decodedMessage = com.zita.client.utils.Base64.decode(encryptedMessage);
