...
import com.zita.client.dh.KeyExchange;
import com.zita.client.utils.Base64;
...
import static com.zita.client.utils.ZitaChatUtils.PROTOCOL_SEPARATOR;
import static com.zita.client.utils.ZitaChatUtils.PUBLIC_KEY;
...
public class ClientApplication extends Application implements KeyExchange.SendKey {
    ...
    public void sendMessage(String message) throws Exception {
        executeSend(ZitaChatUtils.ENCRYPTED_MESSAGE + ZitaChatUtils.PROTOCOL_SEPARATOR + message);
    }

    public void ready() throws Exception {
        executeSend(ZitaChatUtils.READY + ZitaChatUtils.PROTOCOL_SEPARATOR + "ready");
    }
